...
#> ✔ Quarto markdown file created: /tmp/Rtmp43gHy3/output.qmd
...
#> ✔ Quarto markdown file created: /tmp/Rtmp43gHy3/output_with_metadata.qmd
#> Rendering Quarto document to HTML...
#> ! Quarto is not installed or not available in PATH
#> ℹ Install Quarto from <https://quarto.org/docs/get-started/>
...
#> ✔ Quarto markdown file created: /tmp/Rtmp43gHy3/output_styled.qmd
#> Rendering Quarto document to HTML...
#> ! Quarto is not installed or not available in PATH
#> ℹ Install Quarto from <https://quarto.org/docs/get-started/>
...
#> ✔ Quarto markdown file created: /tmp/Rtmp43gHy3/output_quality.qmd
#> Rendering Quarto document to HTML...
#> ! Quarto is not installed or not available in PATH
#> ℹ Install Quarto from <https://quarto.org/docs/get-started/>
# }
