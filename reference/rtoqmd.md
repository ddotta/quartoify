...
#> ✔ Quarto markdown file created: /tmp/RtmpqLgGLh/output.qmd
#> Rendering Quarto document to HTML...
#> ✔ HTML file created: /tmp/RtmpqLgGLh/output.html
...
#> ✔ Quarto markdown file created: /tmp/RtmpqLgGLh/output_with_metadata.qmd
#> Rendering Quarto document to HTML...
#> ✔ HTML file created: /tmp/RtmpqLgGLh/output_with_metadata.html
...
#> ✔ Quarto markdown file created: /tmp/RtmpqLgGLh/output_styled.qmd
#> Rendering Quarto document to HTML...
#> ✔ HTML file created: /tmp/RtmpqLgGLh/output_styled.html
...
#> ✔ Quarto markdown file created: /tmp/RtmpqLgGLh/output_quality.qmd
#> Rendering Quarto document to HTML...
#> ✔ HTML file created: /tmp/RtmpqLgGLh/output_quality.html
# }
```
