...
| **Publication** | HTML/PDF basique | Système de publication Quarto avancé |
...
3. **Sorties Avancées** : Générez des sites web, des livres, des présentations et des articles scientifiques avec le même flux de travail
...
::: {.alert .alert-info}
**Note** : Bien que `knitr::spin()` soit excellent pour des conversions simples vers R Markdown, `quartify` est conçu pour les équipes qui souhaitent exploiter les capacités de publication modernes de Quarto tout en maintenant des scripts R propres et maintenables.
:::
