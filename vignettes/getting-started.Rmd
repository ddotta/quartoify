...
1. **Modern Quarto Ecosystem**: Benefit from Quarto's next-generation features (callouts, tabsets, etc.)
...
📖 **[Advanced Features Guide](advanced-features.html)** - Learn about:
...
🇫🇷 **[Version française](getting-started_FR.html)**: French version of this guide
