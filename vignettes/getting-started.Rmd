...
- This follows the [RStudio code sections convention](https://docs.posit.co/ide/user/ide/guide/code/code-sections.html)
...
- Multiple consecutive comment lines will each become a separate paragraph
...
2. **Trailing symbols**: Section headers MUST have at least 4 trailing symbols (`####`, `====`, or `----`)
3. **No mixing**: Don't mix section syntax (e.g., don't use `## Title ====`)
